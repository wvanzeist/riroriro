...
def wd_polarisations(Mc,freq,d,T_sim,init_phase=0.0,chirp=False):
    ...
    equations 1,2,4. Here we treat the inclination as being optimal; effects
    of inclination are applied by a subsequent function.
    ...
    freq_dot = (96/5) * (freq/Mc) * (pi*freq*Mc)**(8/3) #Shah eq. 4
